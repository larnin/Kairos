...
Shader "Custom/SHD_BlackUnlit_Apparition_Transparent"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 lerpResult116 = lerp( float4( 0,0,0,0 ) , ( saturate( CalculateContrast(5.0,temp_cast_0) ) * float4(0,0.9568628,1,0) * 15.0 * tex2D( _Texture3, panner107 ) ) , ( 1.0 - saturate( tex2D( _TextureSample2, componentMask102 ) ) ).r);
			...
			float2 temp_cast_5 = (( (0.65 + (_Apparition - 0.0) * (0.0 - 0.65) / (1.0 - 0.0)) + _BlackAreaSize )).xx;
			float4 blendOpSrc54 = ( 1.0 - tex2D( _T_Paint02, ( _EffectTiling * componentMask95 ) ) );
			float4 blendOpDest54 = tex2D( _Ramp, (componentMask82*_Scale + temp_cast_5) );
			o.Alpha = ( 1.0 - saturate( CalculateContrast(1.5,( saturate( ( blendOpDest54 > 0.5 ? ( 1.0 - ( 1.0 - 2.0 * ( blendOpDest54 - 0.5 ) ) * ( 1.0 - blendOpSrc54 ) ) : ( 2.0 * blendOpDest54 * blendOpSrc54 ) ) ))) ) ).r;
		}
...
/*ASEBEGIN
Version=13201
1887;288;1449;670;-582.8767;169.1613;1;True;False
...
Node;AmplifyShaderEditor.LerpOp;116;1114.882,-2426.948;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0,0,0,0;False;1;COLOR
Node;AmplifyShaderEditor.OneMinusNode;33;1081.445,221.5451;Float;False;1;0;COLOR;0,0,0,0;False;1;COLOR
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1620.166,-2.378693;Float;False;True;2;Float;ASEMaterialInspector;0;0;Unlit;Custom/SHD_BlackUnlit_Apparition_Transparent;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;Back;0;0;False;0;0;Transparent;0.5;True;True;0;False;Transparent;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;False;0;4;10;25;False;0.5;True;0;Zero;Zero;0;Zero;Zero;Add;Add;0;False;0;0,0,0,0;VertexOffset;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;0;0;14;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;OBJECT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=EFEE615DA252C6BCA9CAEBA11EDD18D2CDABA936