...
namespace ExpressionParser
{
    ...
    public class ComparisonSup : IValue
    {
        private IValue m_Left;
        private IValue m_Right;
        public double Value
        {
            get { return m_Left.Value > m_Right.Value ? 1 : 0; }
        }
        public ComparisonSup(IValue left, IValue right)
        {
            m_Left = left;
            m_Right = right;
        }
    ...
    public class ComparisonSupOrEqual : IValue
    {
        private IValue m_Left;
        private IValue m_Right;
        public double Value
        ...
        public ComparisonSupOrEqual(IValue left, IValue right)
        {
            m_Left = left;
            m_Right = right;
        }
    ...
    public class ComparisonSub : IValue
    {
        private IValue m_Left;
        private IValue m_Right;
        public double Value
        ...
        public ComparisonSub(IValue left, IValue right)
        {
            m_Left = left;
            m_Right = right;
        }
    ...
    public class ComparisonSubOrEqual : IValue
    {
        private IValue m_Left;
        private IValue m_Right;
        public double Value
        ...
        public ComparisonSubOrEqual(IValue left, IValue right)
        {
            m_Left = left;
            m_Right = right;
        }
    ...
    public class ComparisonEqual : IValue
    {
        private IValue m_Left;
        private IValue m_Right;
        public double Value
        ...
        public ComparisonEqual(IValue left, IValue right)
        {
            m_Left = left;
            m_Right = right;
        }
    ...
    public class ComparisonUnequal : IValue
    {
        private IValue m_Left;
        private IValue m_Right;
        public double Value
        ...
        public ComparisonUnequal(IValue left, IValue right)
        {
            m_Left = left;
            m_Right = right;
        }
    ...
    public class ConditionOr : IValue
    {
        private IValue m_Left;
        private IValue m_Right;
        ...
        public double Value
        {
            get { return (m_Left.Value != 0 || m_Right.Value != 0) ? 1 : 0; }
        }
        public ConditionOr(IValue left, IValue right)
        {
            m_Left = left;
            m_Right = right;
        }
    ...
    public class ConditionAnd : IValue
    {
        private IValue m_Left;
        private IValue m_Right;
        ...
        public ConditionAnd(IValue left, IValue right)
        {
            m_Left = left;
            m_Right = right;
        }
    ...
    public class ConditionNot : IValue
    {
        private IValue m_Right;

        public double Value
        {
            get { return m_Right.Value == 0 ? 1 : 0; }
        }
        public ConditionNot(IValue right)
        {
            m_Right = right;
        }
        public override string ToString()
    ...
    public class ExpressionParser
    {
        ...
        public ExpressionParser()
        {
            ...
            m_Funcs.Add("log", (p) => System.Math.Log(p.FirstOrDefault(), 10));
            ...
            m_Funcs.Add("clamp", (p) => System.Math.Min(System.Math.Max(p.FirstOrDefault(), p.ElementAtOrDefault(1)), p.ElementAtOrDefault(2)));
        }
        ...
        IValue Parse(string aExpression)
        {
            ...
            {
                int pos = aExpression.IndexOf(">=");
                var left = Parse(aExpression.Substring(0, pos));
                var right = Parse(aExpression.Substring(pos + 2));
                return new ComparisonSupOrEqual(left, right);
            }
            else if (aExpression.Contains("<="))
            {
                int pos = aExpression.IndexOf("<=");
                var left = Parse(aExpression.Substring(0, pos));
                var right = Parse(aExpression.Substring(pos + 2));
                return new ComparisonSubOrEqual(left, right);
            }
            else if (aExpression.Contains("!="))
            {
                int pos = aExpression.IndexOf("!=");
                var left = Parse(aExpression.Substring(0, pos));
                var right = Parse(aExpression.Substring(pos + 2));
                return new ComparisonUnequal(left, right);
            }
            else if (aExpression.Contains('='))
            {
                int pos = aExpression.IndexOf('=');
                var left = Parse(aExpression.Substring(0, pos));
                var right = Parse(aExpression.Substring(pos + 1));
                return new ComparisonEqual(left, right);
            }
            else if (aExpression.Contains('>'))
            {
                int pos = aExpression.IndexOf('>');
                var left = Parse(aExpression.Substring(0, pos));
                var right = Parse(aExpression.Substring(pos + 1));
                return new ComparisonSup(left, right);
            }
            else if (aExpression.Contains('<'))
            {
                int pos = aExpression.IndexOf('<');
                var left = Parse(aExpression.Substring(0, pos));
                var right = Parse(aExpression.Substring(pos + 1));
                return new ComparisonSub(left, right);
            }
            else if(aExpression.Contains("&&"))
            {
                int pos = aExpression.IndexOf("&&");
