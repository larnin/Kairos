...
public class ConditionalEventClip : PlayableAsset, ITimelineClipAsset, ISerializationCallbackReceiver, ISupportsPrefabSerialization
{
    ...
    {
        var playable = ScriptPlayable<ConditionalEventBehaviour>.Create (graph);
